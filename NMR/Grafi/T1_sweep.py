...
fr = np.array([56.08, 56.12, 56.16, 56.21, 56.25, 56.29])

### 80 K
Podatki1 = np.genfromtxt(r"NMR\NMR obdelava 20230810\data\YbBeGeO\csv\T1\T1-22dB-Yb2Be2GeO7-9Be-sweep-56p08MHz copy.csv", delimiter=";")
Podatki2 = np.genfromtxt(r"NMR\NMR obdelava 20230810\data\YbBeGeO\csv\T1\T1-22dB-Yb2Be2GeO7-9Be-sweep-56p12MHz.csv", delimiter=";")
Podatki3 = np.genfromtxt(r"NMR\NMR obdelava 20230810\data\YbBeGeO\csv\T1\T1-22dB-Yb2Be2GeO7-9Be-sweep-56p16MHz.csv", delimiter=";")
Podatki4 = np.genfromtxt(r"NMR\NMR obdelava 20230810\data\YbBeGeO\csv\T1\T1-22dB-Yb2Be2GeO7-9Be-sweep-56p21MHz.csv", delimiter=";")
Podatki5 = np.genfromtxt(r"NMR\NMR obdelava 20230810\data\YbBeGeO\csv\T1\T1-22dB-Yb2Be2GeO7-9Be-sweep-56p25MHz.csv", delimiter=";")
Podatki6 = np.genfromtxt(r"NMR\NMR obdelava 20230810\data\YbBeGeO\csv\T1\T1-22dB-Yb2Be2GeO7-9Be-sweep-56p29MHz.csv", delimiter=";")
...
T1_56p08 =np.concatenate((T1_1, T1_2, T1_3, T1_4, T1_5, T1_6))
T1_56p08_err =np.concatenate((T1_1_err, T1_2_err, T1_3_err, T1_4_err, T1_5_err, T1_6_err))

plt.errorbar(fr, T1_56p08, yerr=T1_56p08_err, linestyle='None', marker='.', capsize=3, label="$80$ K")

graf_oblika(r"$T_1$ pri različnih frekvencah", r"$f$ [MHz]", r"$T_1$ [s]", legenda=0)
